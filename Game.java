...
public class Game {
    ...
    public static void playerNextMoveAction(int currentX, int currentY, int nextX, int nextY) {
        if (invisibleMap[nextY][nextX] == enemy) {
            while (enemyHealth > 0 && playerHealth > 0) {
                ...
                System.out.println("Alarm! Player give damage " + playerAttackPoint + ". Enemy health now is " + enemyHealth + "!");
    ...
    public static void createEnemies() {
        ...
        staticEnemyHealth = randomRange(enemyValueMin, enemyValueMax);
        enemyHealth = staticEnemyHealth;
        ...
        for (int i = 0; i < enemyCount; i++) {
            ...
            } while (enemyPosX == playerPositionX && enemyPosY == playerPositionY && invisibleMap[enemyPosY][enemyPosX] == ' ');
    ...
    public static void createPlayer() {
        ...
        System.out.println("Player power = " + playerAttackPoint + ", Player Health = " + playerHealth);
    }
