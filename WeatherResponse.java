...
public class WeatherResponse {
    ...
    public class Temperature {
        ...
        private WeatherResponse.Temperature.Metric metric;

        public WeatherResponse.Temperature.Metric getMetric() {
            return metric;
        }

        public void setMetric(WeatherResponse.Temperature.Metric metric) {
            this.metric = metric;
        }
